...
class Appointmentmodel {
  ...
  factory Appointmentmodel.fromMap(Map<String, dynamic> map) {
    return Appointmentmodel(
      ...
      Appointmentstatus: map['Appointmentstatus'] != null
      ...
      Patientimageurl: map['Patientimageurl'] != null
          ...
          : null,
      Patientproblem: map['Patientproblem'] != null
          ? map['Patientproblem'] as String
          : null,
      patientid: map['patientid'] != null ? map['patientid'] as String : null,
      canellationreason: map['canellationreason'] != null
          ? map['canellationreason'] as String
          : null,
    );
  }
  ...
  @override
  String toString() {
    return 'Appointmentmodel(doctorName: $doctorName, doctorid: $doctorid, specialty: $specialty, date: $date, time: $time, Appointmentstatus: $Appointmentstatus, doctorimage: $doctorimage, bookingid: $bookingid, patientname: $patientname, Patientimageurl: $Patientimageurl, Patientproblem: $Patientproblem, patientid: $patientid, canellationreason: $canellationreason)';
  }
